...
logger = function(api, cb) {
  var eql, extend, next, sqlDateTime, _ref;
  _ref = api.utils, next = _ref.next, eql = _ref.eql, extend = _ref.extend, sqlDateTime = _ref.sqlDateTime;
  ConsoleBackend.write = function() {
    var args;
