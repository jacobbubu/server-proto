...
ServerProto = (function() {
  ...
  ServerProto.prototype.initialize = function(options, cb) {
    ...
    orderedInitializers = {};
    ['configObj', 'logger', 'stats', 'redis', 'resque', 'tasks'].forEach(function(i) {
  ...
  ServerProto.prototype.stop = function(cb) {
    ...
    if (self.api.running) {
      ...
      orderedTeardowns = {};
      ['tasks', 'resque', 'configObj'].forEach(function(terdown) {
      ...
      for (terdown in _ref2) {
        obj = _ref2[terdown];
        if (hasFunc(obj, '_stop') && (orderedTeardowns[terdown] == null)) {
          (function(name) {
            return orderedTeardowns[name] = function(cb) {
              return self.api[name]._stop(self.api, cb);
            };
